      ...
      while (w == '1'):
        ...
        if a2=='6':
            ...
            if a3=='520特别福利':
                ...
                a520=input('请输入爱情选项：')
                if a520=='1':
                   sentence = 'You know? actually, I love you'  # Dear, I love you forever!
                   for char in sentence.split():
                    ...
                    hs2('这是我从来都没有收到过的')
                    time.sleep(1)
                    hs2('啊，我的心，像有一万只象征着爱情的羊驼在肆意的奔跑')
                    time.sleep(1)
                    hs2('马蹄下步步生莲，所有心动的思绪都浸润在清雅的香味之中')
                    time.sleep(1)
            elif a3 == '操作页面':
                www=1
                while www==1:
                ...
                if '仙丹'in L1:
                   print('您已使用仙丹')
                   Lifevaluelimit=Lifevaluelimit+1000
                   Lifevalue1=Lifevaluelimit
                   del L1[L1.index('仙丹')]
                   if Lifevalue1>=Lifevaluelimit:
                      Lifevalue1=Lifevaluelimit
               ...
               if '金疮药'in L1:
                ...
                L2.append(wuping)
                wuping = input('军队：')
                renxxx=int(input('军队人数：'))
                for i in range(0,renxxx):
                   L3.append(wuping)
                w = '1'
            else:
                w = '1'
            ...
            while (wjiaowai == '10'):
                      ...
                      while huitou1==0:
                       ...
                       if aws=='0':
                           ...
                           if aws=='1':
                            ...
                            saiwaijn=saiwaijn+1
                            if saiwaijn==1:
                               print('你来到了塞外江南，遇见了当地壮士')
                               time.sleep(0.5)
                               qs('壮士：你是谁？来我们这何事？')
                               time.sleep(0.5)
                               hs2('1.我是奉命前来剿匪的将军，特来招募各位，共抗敌寇，保卫家园！')
                               time.sleep(0.5)
                               hs2('2.我是前来征战的士兵，你们愿意和我一同并肩作战吗？')
                               time.sleep(0.5)
                               hs2('3.将军参前中郎将，特来拜会各位，还望各位勠力同心，杀尽来犯之人！')
                               time.sleep(0.5)
                               iwididsijdjsd=input('请输入选项：')
                               qs('壮士：既如此，我们岂能不出份力！')
                               time.sleep(0.5)
                               hs1('这些壮士家中都有妻儿子女，请提前给抚恤金（决定招募到的人数）：')
                               aws=input('1.百金2.千金3.3000金4.6000金5.万金')
                               if aws=='1':
                                if money>=100:
                                   hs1('你招募到了1个壮士！！！！！！！！！！！！！！')
                                   L3.append('壮士')
                                ...
                                print('你想再回到塞外江南，却发现怎么找也找不到了')
                           elif aws=='3':
                             if yanshan==1:
                               huqi=3000
                               xue1() 
                               taopao=1
                               while huqi>0 and xue>0 and taopao==1 :
                                            ...
                                            if aws=='1':
                                                ...
                                                if isss==1:
                                                   zs('将士们，为了我们的家园，上啊！')
                                                    ...
                                                    zs('杀尽来犯寇，保卫我河山！')
                                                hs1('将士们受到鼓舞，每名壮士攻击力加倍！效果持续3回合。')
                                                guwu=guwu+3
                                            elif aws=='2':
                                                zs('你带头冲锋，不畏强敌！')
                                                hs1('将士们受到你的精神的感染，个个悍不畏死！（每名壮士攻击力翻三倍！受到的伤害乘三，效果持续2回合）')
                                                shangdi=shangdi+2
                                            else:
                                                print('输入错误，战斗可容不得马虎大意，不可被给予第二次机会，迎接胡骑的突袭吧！')
                                            hzld('胡骑趁你不注意突袭了你！') 
                                            gongji2=random.randint(10, 80)
                                            xue=xue-gongji2
                                            hzld3('胡骑对你的军团造成了')
                                            print(gongji2,end='')
                                            hzld3('点伤害，你的军团还剩')
                                      ...
                                      if xue<=0:
                                        ...
                                        if huqi<=0:
                                          if diaoluo==5:
                                              ...
                                              zs('你拯救了敌军俘获的壮士和乡亲，功德无量，壮士+1')
                                              L3.append('壮士')
                                          elif diaoluo==3 or diaoluo==4:
                                              zs('你找到了对方藏军用物资的地方，获得驽马*10')
                                              for i in range(0,10):
                                                  L4.append('驽马')
                                          elif diaoluo==6 or diaoluo==7:
                                              zs('你经过此次磨砺，战力有所长进，生命及生命上限+50')
                                              Lifevaluelimit=Lifevaluelimit+50
                                              Lifevalue1=Lifevalue1+50
                                          elif diaoluo==8:
                                              zs('你获得了西市赌坊的秘密！')
                                              zs('张三一半的概率赢，若张三是对的，李四50%跟张三一样，25%押大，25%押小。若张三是错的，李四50%押大，50%押小。求李四赢的概率是多少？')
                                          else:
                                              zs('你获得了小还丹*3')
                                              for i in range(0,3):
                                                  L1.append('小还丹')
                                      ...
                                      if xue<=0:
                                        ...
                                        if huqi<=0:
                                          if diaoluo==5:
                                              ...
                                              zs('你拯救了敌军俘获的壮士和乡亲，功德无量，壮士+5')
                                              for i in range(0,5):
                                                 L3.append('壮士')
                                          elif diaoluo==3 or diaoluo==4:
                                              zs('你找到了对方藏军用物资的地方，获得骐骥*3')
                                              for i in range(0,3):
                                                  L4.append('骐骥')
                                          elif diaoluo==6 or diaoluo==7:
                                              print('你经过此次磨砺，战力有所长进，生命及生命上限+80')
                                              Lifevaluelimit=Lifevaluelimit+80
                                              Lifevalue1=Lifevalue1+80
                                          elif diaoluo==8:
                                              zs('你获得了西市赌坊的秘密！')
                                              zs('张三一半的概率赢，若张三是对的，李四50%跟张三一样，25%押大，25%押小。若张三是错的，李四50%押大，50%押小。求李四赢的概率是多少？')
                                          else:
                                      ...
                                      if xue<=0:
                                        ...
                                        if huqi<=0:
                                          if diaoluo==5:
                                              ...
                                              zs('你拯救了敌军俘获的壮士和乡亲，功德无量，壮士+10')
                                              for i in range(0,10):
                                                  L3.append('壮士')
                                          elif diaoluo==3 or diaoluo==4:
                                              zs('你找到了对方藏军用物资的地方，获得良马*10')
                                              for i in range(0,10):
                                                  L4.append('良马')
                                          elif diaoluo==6 or diaoluo==7:
                                              zs('你经过此次磨砺，战力有所长进，生命及生命上限+100')
                                      ...
                                      if xue<=0:
                                        ...
                                        if huqi<=0:
                                          if diaoluo==5:
                                              ...
                                              zs('你拯救了敌军俘获的壮士和乡亲，功德无量，壮士+20')
                                              for i in range(0,20):
                                                  L3.append('壮士')
                                          elif diaoluo==3 or diaoluo==4:
                                              zs('你找到了对方藏军用物资的地方，获得骐骥*10')
                                              for i in range(0,10):
                                                  L4.append('骐骥')
                                          elif diaoluo==6 or diaoluo==7:
                                              zs('你经过此次磨砺，战力有所长进，生命及生命上限+300')
                                              Lifevaluelimit=Lifevaluelimit+300
                                              Lifevalue1=Lifevalue1+300
                                          elif diaoluo==8:
                                            zs('你获得散落在外的君子剑')
                                            L2.append('君子剑')
                                          else:
                               ...
                               taopao=1
                               while huqi>0 and xue>0 and taopao==1 :
                                     zs('你又又又又又来到了燕山！遇到了在这盘踞的一股终极胡骑势力！！！')
                                     bdhz('0.挑衅对方2.战！')
                                     aws=input('请输入选项：')
                                     if aws=='0':
                                         hs1('你过来啊！')
                                      ...
                                      while huqi>0 and xue>0 and taopao==1:
                                        ...
                                        if aws=='3':
                                            taopao=2
                                            hzld('胡骑对你发起了冲锋！') 
                                            gongji2=random.randint(100, 500)
                                            if shangdi>0:
                                             gongji2=gongji2*3
                                            xue=xue-gongji2
                                            hzld3('胡骑对你的军团造成了')
                                         ...
                                         hs2('点血量')
                                            ...
                                            if aws=='1':
                                                ...
                                                print('输入错误，战斗可容不得马虎大意，不可被给予第二次机会，迎接胡骑的突袭吧！')
                                            hzld('胡骑趁你不注意突袭了你！') 
                                            gongji2=random.randint(100, 300)
                                            xue=xue-gongji2
                                            hzld3('胡骑对你的军团造成了')
                                            print(gongji2,end='')
                                            hzld3('点伤害，你的军团还剩')
                                      ...
                                      if xue<=0:
                                        ...
                                        if huqi<=0:
                                          if diaoluo==5:
                                              ...
                                              zs('你拯救了敌军俘获的壮士和乡亲，功德无量，壮士+50')
                                              for i in range(0,50):
                                                  L3.append('壮士')
                                          elif diaoluo==3 or diaoluo==4:
                                              zs('你找到了对方藏军用物资的地方，获得骐骥*30')
                                              for i in range(0,30):
                                                  L4.append('骐骥')
                                          elif diaoluo==6 or diaoluo==7:
                                              zs('你经过此次磨砺，战力有所长进，生命及生命上限+1000')
                                              Lifevaluelimit=Lifevaluelimit+1000
                                              Lifevalue1=Lifevalue1+1000
                                          elif diaoluo==8:
                                            zs('你获得散落在外的天子剑')
                                            L2.append('天子剑')
                                          else:
                                              zs('你获得了仙丹*1')
                                              zs('仙丹说明：在天台输入仙丹可使用，加1000血量上限，并将体力值回满')
                                              for i in range(0,1):
                                                  L1.append('仙丹')
                                     else:
                                         print('好家伙，你这一路上都错了多少回了~')
                                     ...
                                     if aws=='0':
                                      ...
                                      while huqi>0 and xue>0 and taopao==1:
                                        ...
                                        if aws=='3':
                                            taopao=2
                                            hzld('胡骑对你发起了冲锋！') 
                                            gongji2=random.randint(500, 500)
                                            if shangdi>0:
                                             gongji2=gongji2*3
                                            xue=xue-gongji2
                                            hzld3('胡骑对你的军团造成了')
                                         ...
                                         hzld('胡骑对你发起了冲锋！') 
                                         gongji2=random.randint(450, 450)
                                         if shangdi>0:
                                             gongji2=gongji2*3
                                         xue=xue-gongji2
                                         hzld3('胡骑对你的军团造成了')
                                         ...
                                         hs2('点血量')
                                            ...
                                            if aws=='1':
                                                ...
                                                print('输入错误，战斗可容不得马虎大意，不可被给予第二次机会，迎接胡骑的突袭吧！')
                                            hzld('胡骑趁你不注意突袭了你！') 
                                            gongji2=random.randint(300, 300)
                                            xue=xue-gongji2
                                            hzld3('胡骑对你的军团造成了')
                                            print(gongji2,end='')
                                            hzld3('点伤害，你的军团还剩')
                                      ...
                                      if xue<=0:
                                        ...
                                        if huqi<=0:
                                          if diaoluo==5:
                                              ...
                                              zs('你拯救了敌军俘获的壮士和乡亲，功德无量，壮士+100')
                                              for i in range(0,100):
                                                  L3.append('壮士')
                                          elif diaoluo==3 or diaoluo==4:
                                              zs('你找到了对方藏军用物资的地方，获得骏马*30')
                                              for i in range(0,30):
                                                  L4.append('骏马')
                                          elif diaoluo==6 or diaoluo==7:
                                              zs('你经过此次磨砺，战力有所长进，生命及生命上限+3000')
                                              Lifevaluelimit=Lifevaluelimit+3000
                                              Lifevalue1=Lifevalue1+3000
                                          elif diaoluo==8:
                                            zs('你获得散落在外的天子剑')
                                            L2.append('天子剑')
                                          else:
                             ...
                             while huitou2==0:
                                ...
                                if aws=='0':
                                  ...
                                  guanshan=0
                                  while guanshan==0:
                                    hzld('1.一心向北，千里疾行！2.准备御寒物资')#还未写
                                    if guanshan1==0 and guanshan2==0:
                                        print('3.两者兼顾')
                                    aws=input('请输入选项：')
                                    if aws=='2':
                                        bdhz('延误军情，实属不智')
                                        ...
                                        bdhz('群情激愤，事不可为')
                                        guanshan2=0
                                    if guanshan1==0 and guanshan2==0 and aws=='3':
                                        zs('如此甚好')
                                        time.sleep(1.5)
                                        zs('那便由你留下准备物资吧！')
                                else:
                ...
                #
                    ...
                    print('你来到了矿山')
                    print('1.失落的矿山（未开放）2.奴隶主的私人矿山')
                    aws=input('请输入选项：')
                    if aws=='2':
                      ks1=0
                      while ks1==0:
                        print('你偷偷来到了奴隶主的私人矿山')
                        print('0.返回1.偷矿2.煽动奴隶造反3.创建工会（未开放）')
                        aws=input('请输入选项：')
                        if aws=='0':
                            ks1=2
                        elif aws=='2':
                            issdsd=random.randint(1, 10)
                            if issdsd==1:
                                print('造反失败，生命-50')
                                Lifevalue1=Lifevalue1-50
                            elif issdsd==2:
                          ...
                          while ks2==0:
                            ...
                            if issdsd==1:
                                ...
                                if aws=='0':
                                    ...
                                    print('你被发现了，被当成奴隶去打黑工，过了好久好久才被你逃出来（请耐心等待3秒）')
                                    time.sleep(3)
                          if kuangshi>0:
                              if kuangshi>2 and kuangshi<4:
                                  print('你获得了3块矿石')
                                  L1.append('矿石')
                                  L1.append('矿石')
                                  L1.append('矿石')
                              elif kuangshi>7:
                                  print('你获得了',kuangshi,'块矿石')
                                  for i in range(0,kuangshi):
                                      L1.append('矿石')
                              elif kuangshi>=4 and kuangshi<=6:
                                  print('你获得了5块矿石')
                                  for i in range(0,5):
                                      L1.append('矿石')
                              else:
                                    ...
                                    while (ww1 == '0'):
                                        ...
                                        if (attack == '1'):
                                            if ('爆竹' in L1):
                                                ...
                                                print('你点燃了爆竹，朝年兽扔了过去，成功命中！造成了500点伤害，年兽剩余生命值为', Lifevalue2)
                                            else:
                            ...
                            while qigai1=='1':
                                  ...
                                  if qigai=='2':
                                     ...
                                     tao2=2
                                      ...
                                      qigai1='2'
                                      if tao1==2 and tao2==2 and tao3==2 and tao4==2 and taoyici==0:
                                ...
                                while (w3 != '0'):
                                    ...
                                    if (a2111 == '1'):
                                        ...
                                        if jia==0:
                                            ...
                                            jia=jia+1
                                            print('\033[1;31m 乱花醉人伤，野花遍野茫 \033[0m')
                                            time.sleep(1)
                                    elif (a2111 == '0'):
                                              w3 = '0'
                                    else:
